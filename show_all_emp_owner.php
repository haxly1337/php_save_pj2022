...
//         echo "<script>alert('$name_error'); window.location.href='show_all_emp_owner.php';</script>";
//     } else if (mysqli_num_rows($res_e) > 0) {
//         $email_error = "อีเมลนี้มีผู้อื่นใช้ไปเเล้ว";
//         echo "<script>alert('$email_error'); window.location.href='show_all_emp_owner.php';</script>";
//     } else {
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="sumbit" class="btn btn-primary" name="sumbit_register">เพิ่มพนักงาน</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
