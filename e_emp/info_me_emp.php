    ...
    if (isset($_POST['change_info_user'])) {
        ...
        if ($file != "") {
            ...
            if ($query_update_run) {
                ...
                echo "<script>alert('$message_nointo'); window.location.href='info_me_emp.php';</script>";
            } else {
            ...
            <div class="card m-auto w-75">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md">
                            <a class="btn btn-primary" href="index_backend_emp.php" role="button" style="float: right;">กลับหน้าหลัก</a>
                        </div>
