...
//! Sumbit_Promotion //
{
    ...
    if (isset($_POST['sumbit_promotion'])) {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('$message_nointo'); window.location.href='data_new.php';</script>";
        } else {
...
//! Update_Promotion //
{
    ...
    if (isset($_POST['sumbit_update_promotion'])) {
        ...
        if ($query_update_run) {
            $_SESSION['success'] = "ทำการเเก้ข้อมูลสำเร็จ";
            $message_nointo =  $_SESSION['success'];
            echo "<script>alert('$message_nointo'); window.location.href='data_new.php';</script>";
        } else {
            $_SESSION['error'] = "เกิดข้อผิดพลางบางอย่าง";
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-lg">
            <div class="card m-auto mt-3 w-100">
                <div class="card-body">
                    <div class="col-lg">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 p-0">
                                            <a href="del_news_owner.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการยกเลิกการโปรโมชั่นใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                        </td>
