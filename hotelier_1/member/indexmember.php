...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>WELCOME TO FAIKHAM HOTEL</title>
    ...
    <body>
        <div class="container-xxl bg-white p-0">
            ...
            <!-- Header Start -->
            <div class="container-fluid bg-dark px-0 position-relative">
                <div class="row gx-0">
                    <div class="col-lg-3 bg-dark  d-lg-block">
                ...
                <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img class="w-100" src="../imge/faikham-3.png" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Luxury Living</h6>
                                    <h1 class="display-3 text-white mb-4 animated slideInDown">Welcome to Faikham Hotel</h1>
