                        ...
                        <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0">
                                    ...
                                    <a href="../guest/room.html" class="nav-item nav-link">Rooms</a>
                                    <div class="nav-item dropdown">
                                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">News</a>
                                        <div class="dropdown-menu rounded-0 m-0">
                                            <a href="../guest/news.html" class="dropdown-item">News</a>
                                            <a href="../guest/promotion.html" class="dropdown-item">Promotions</a>
                                        </div>
                                    </div>
                                    <a href="../guest/review.html" class="nav-item nav-link">Review</a>
                                    <a href= "login/login.html"class="nav-item nav-link">Login/Register</a>
                                </div>
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-top">
                                <div class="p-0" style="max-width: 700px;">
                                    ...
                                    <div class="p-0" style="max-width: 500px;">
                                        <h6 class=" text-white text-uppercase mb-3 animated slideInDown">FAIKHAM HOTEL</h6></div>
