...
if (isset($_POST['sumbit_register'])) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
        ...
        echo "<script>alert('$name_error'); window.location.href='show_all_mem.php';</script>";
    } else if (mysqli_num_rows($res_e) > 0) {
        $email_error = "อีเมลนี้มีผู้อื่นใช้ไปเเล้ว";
        echo "<script>alert('$email_error'); window.location.href='show_all_mem.php';</script>";
    } else {
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="col-sm">
                                                                        <div class="mt-2">
                                                                            <div>
                                                                                <label for="Input_Text" class="form-label" style="float: left; font-size: 18px;">เงินเดือน</label>
                                                                                <input type="text" class="form-control" id="Input_Text" name="cus_salary" placeholder="ตัวอย่าง : 10,000 บาท" value="<?php echo $all_user_salary_format . " บาท" ?>" required>
