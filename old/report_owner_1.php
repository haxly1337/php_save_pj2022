                                      ...
                                      <tr>
                                          ...
                                          <td class="text-center" style="width: 80px;">
                                              <form action="list_book_show_img_owner.php" method="POST" enctype="multipart/form-data">
                                                  ...
                                                  <button type="submit" class="btn btn-primary" type="submit" name="show_new_page_img" <?=($row['rdt_st']=='0') ? $disabled:'' ?>><i class="lni lni-support"></i></button>
                                              </form>
                                          ...
                                          <td class="text-center" style="width: 80px;">
                                            <a class="btn btn-success"  <?=($row['rdt_st']!='2') ? $disabled:'' ?> href="index_backend_owner_NEW.php?book_id=<?=$row['book_id']; ?>&receipt_no=<?=$row['receipt_no']; ?>&Stats=cf" onclick="return confirm('คุณต้องการยืนยันการจองใช่ใหม?')"><i class="lni lni-save"></i></i></a>
                                          </td>

                                          <td class="text-center" style="width: 80px;">
                                            <a class="btn btn-warning"  <?=($row['rdt_st']!='2') ? $disabled:'' ?> href="index_backend_owner_NEW.php?book_id=<?=$row['book_id']; ?>&receipt_no=<?=$row['receipt_no']; ?>&Stats=ucf" onclick="return confirm('คุณต้องการยกเลิกการจองใช่ใหม?')"><i class="lni lni-cut"></i></i></a>
                                          </td>

                                          <td class="text-center" style="width: 80px;">
                                            <a class="btn btn-info"     <?=($row['rdt_st']!='1') ? $disabled:'' ?> href="index_backend_owner_NEW.php?book_id=<?=$row['book_id']; ?>&receipt_no=<?=$row['receipt_no']; ?>&Stats=co" onclick="return confirm('คุณต้องการเช็คเอาท์ใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                          </td>

                                          <td class="text-center" style="width: 80px;">
                                            <a class="btn btn-danger"   <?=($row['rdt_st']!='0') ? $disabled:'' ?> href="index_backend_owner_NEW.php?room_id=<?php echo $row['rdt_id']; ?>" onclick="return confirm('คุณต้องการลบห้องพักใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                          </td>
