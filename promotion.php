...
<body>
    ...
    <div class="setcarouel">
        <div class="col-lg-7 m-auto px-4 py-3 bg-white mt-2">
            <h1 class='p-2'>ข้อมูลโปรโมชั่น</h1>
            <br>
            <?php 
                ...
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo "<a href='promotion_detail.php?id=$id'>
                    <div class='row'>
                           <div class='col-5'>";
                           if(empty($pomotio_img))
                           {
                               echo "<img src='img/promotion/d.png' width='300' height='200'>";
                           }
                           else
                           {
                               echo " <img src='img/promotion/$pomotio_img' width='300' height='200'>";
                           }
                           echo "</div><div class ='col-7'>
                               <h2>$pomotio_name</h2>
                               รายละเอียด : $pomotio_detail
                           </div>
                       </div>
                   </a>";
                }
