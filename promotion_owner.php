...
//! Sumbit_Promotion //
{
    ...
    if (isset($_POST['sumbit_promotion'])) {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('$message_nointo'); window.location.href='promotion_owner.php';</script>";
        } else {
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-3 p-0">
                                                            <a href="del_promotion_owner.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการยกเลิกการโปรโมชั่นใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                                        </td>
