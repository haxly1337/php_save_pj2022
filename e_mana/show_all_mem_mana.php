...
if (isset($_POST['sumbit_register'])) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
        ...
        echo "<script>alert('$name_error'); window.location.href='show_all_mem_mana.php';</script>";
    } else if (mysqli_num_rows($res_e) > 0) {
        $email_error = "อีเมลนี้มีผู้อื่นใช้ไปเเล้ว";
        echo "<script>alert('$email_error'); window.location.href='show_all_mem_mana.php';</script>";
    } else {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('$message_nointo'); window.location.href='show_all_mem_mana.php';</script>";
        } else {
...
<head>
    ...
    <title>เเสดงชื่อสมาชิกทั้งหมด</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm">
                                        <a class="btn btn-primary" href="index_backend_manager.php" role="button">กลับหน้าหลัง</a>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-2">
                                                <div class="col-md">
                                                    ...
                                                    <select id="Input_Hotel" class="form-select" name="emp_select_role" value="emp">
                                                        <option value="emp">พนักงาน</option>
                                                        <option value="maid">พนักงานทำความสะอาด</option>
                                                        <option value="coun">คนเฝ้าเคาน์เตอร์</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td> <a href="del_show_all_mem_mana.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลใช่ใหม ?')">ลบข้อมูล</a></td>
                                        </tr>
                                    <?php
                                    }
                                } else { ?>
