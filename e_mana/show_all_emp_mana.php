...
if (isset($_POST['sumbit_register'])) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
        ...
        echo "<script>alert('$name_error'); window.location.href='show_all_emp_mana.php';</script>";
    } else if (mysqli_num_rows($res_e) > 0) {
        $email_error = "อีเมลนี้มีผู้อื่นใช้ไปเเล้ว";
        echo "<script>alert('$email_error'); window.location.href='show_all_emp_mana.php';</script>";
    } else {
    ...
    if (isset($_POST['change_info_emp'])) {
        ...
        if ($file != "") {
            ...
            if ($query_update_run) {
                ...
                echo "<script>alert('$message_nointo'); window.location.href='show_all_emp_mana.php';</script>";
            } else {
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md m-auto">
                            <a class="btn btn-primary" href="index_backend_manager.php" role="button" style="float: right;">กลับหน้าหลัก</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center" style="padding: 8px;">
                                                    <a href="del_show_all_emp_mana.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                                </td>
