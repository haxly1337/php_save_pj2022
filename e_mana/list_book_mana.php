...
if (isset($_POST['check_status_pay'])) {
    ...
    if ($result_insert) {
        ...
        echo "<script>alert('$message_nointo'); window.location.href='list_book_mana.php';</script>";
    } else {
                    ...
                    <form name="frmSearch" method="get" action="">
                        ...
                        <div class="col-lg">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a class="btn btn-primary mt-3" href="index_backend_manager.php" style="float: right;" role="button">กลับหน้าหลัก</a>
                                </div>
                            </div>
                                    ...
                                    foreach ($query_run_hotel as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 80px;">
                                                <form action="list_book_show_img_mana.php" method="POST" enctype="multipart/form-data">
                                                    <div class="hide">
                                            ...
                                            <td class="text-center" style="width: 80px;">
                                                <a href="list_book_del_mana.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบการยกเลิกจองใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                            </td>
