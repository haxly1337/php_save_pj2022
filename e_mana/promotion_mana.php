...
//! Sumbit_Promotion //
{
    ...
    if (isset($_POST['sumbit_promotion'])) {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('$message_nointo'); window.location.href='promotion_mana.php';</script>";
        } else {
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <a class="btn btn-primary" href="index_backend_manager.php" style="float: right;" role="button">กลับหน้าหลัก</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 p-0">
                                            <a href="del_promotion_mana.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการยกเลิกการโปรโมชั่นใช่ใหม ?')"><i class="lni lni-trash-can"></i></a>
                                        </td>
