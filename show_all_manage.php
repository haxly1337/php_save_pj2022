...
if (isset($_POST['sumbit_register'])) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
        ...
        echo "<script>alert('$name_error'); window.location.href='show_all_manage.php';</script>";
    } else if (mysqli_num_rows($res_e) > 0) {
        $email_error = "อีเมลนี้มีผู้อื่นใช้ไปเเล้ว";
        echo "<script>alert('$email_error'); window.location.href='show_all_manage.php';</script>";
    } else {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('$message_nointo'); window.location.href='show_all_manage.php';</script>";
        } else {
...

{
    if (isset($_POST['change_info_emp'])) {
        ...
        if ($query_update_run) {
            ...
            $message_nointo =  $_SESSION['success'];
            echo "<script>alert('$message_nointo'); window.location.href='show_all_mem.php';</script>";
        } else {
...
<head>
    ...
    <title>เเสดงรายชื่อผู้จัดการทั้งหมด</title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-lg text-center">
                        <h4>เเสดงรายชื่อผู้จัดการทั้งหมด</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm">
                                        <a class="btn btn-primary" href="owner.php" role="button">กลับหน้าหลัง</a>
                                        <button type="submit" class="btn btn-success" name="show_all_name_emp" id="">เเสดงรายชื่อจัดการทั้งหมด</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-2">
                                                <div class="col-md">
                                                    ...
                                                    <select id="Input_Hotel" class="form-select" name="emp_select_role_show" value="ผู้จัดการ" disabled>
                                                        <option value="mana">ผู้จัดการ</option>
                                                    </select>
                                                    <input type="hidden" class="form-control" id="Input_Text" name="emp_select_role" value="mana">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm">
                                                <div class="mt-2">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="Input_Text" name="cus_salary_2" placeholder="ตัวอย่าง : 10,000 บาท" required>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm">
                                                                            <div class="mt-2">
                                                                                <div>
                                                                                    <label for="Input_Text" class="form-label" style="float: left; font-size: 18px;">เบอร์มือถือ</label>
                                                                                    <input type="text" class="form-control" id="Input_Text" name="cus_tel" placeholder="ตัวอย่าง : 0910791234" value="<?php echo $row['tel'] ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    $query_emp = "SELECT * FROM all_user WHERE (role = 'mana')";
                                    $query_run_emp = mysqli_query($conn, $query_emp);
