                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="room.php" class="nav-item nav-link">ห้องของเรา</a>
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">ข่าวประชาสัมพันธ์</a>
                                    <div class="dropdown-menu rounded-0 m-0">
                                        <a href="news.php" class="dropdown-item">ข่าวประชาสัมพันธ์</a>
                                        <a href="promotion.php" class="dropdown-item">โปรโมชั่น</a>
                                    </div>
                                </div>
                                ...
                                if (($show_something_1) == 0) {
                                    ...
                                    <a href="table_booking.php" class="nav-item nav-link">ตารางการจอง</a>
