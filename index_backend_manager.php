...
?>
  ...
  <head>
    ...
    <title>ผู้จัดการ <?php echo "คุณ : " . $_SESSION['first_name'] ?></title>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="show_all_emp_mana.php"> ข้อมูลพนักงาน </a>
              </li>
              <li>
                <a href="show_all_mem_mana.php"> ข้อมูลสมาชิก</a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_2" aria-controls="ddmenu_2" aria-expanded="false" aria-label="Toggle navigation">
              ...
              <span a href="list_book_mana.php"> จัดการห้องพัก </a></span>
            </a>
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              ...
              <li>
                <a href="promotion_mana.php"> โปรโมชั่น </a>
              </li>
              <li>
                <a href="news_mana.php"> ข่าวประชาสัมพันธ์ </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_55" aria-controls="ddmenu_55" aria-expanded="false" aria-label="Toggle navigation">
              ...
              <span class="text">จัดการการจองห้องพักลูกค้า Walkin</span>
            </a>
            <ul id="ddmenu_55" class="collapse dropdown-nav">
              <li>
                <a href="addwalkin_mana.php"> จองห้องพักลูกค้า Walkin </a>
              </li>
              <li>
                <a href="show_all_book_mana.php"> ข้อมูลการจองห้องพักลูกค้า Walkin </a>
              </li>
            </ul>
          </li>
